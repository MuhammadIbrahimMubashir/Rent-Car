...
import cultus from "../images/cultus.png";
...
export default function Budget() {
  ...
  return (
    <div className="px-4">
      <title>Budget-QuickRent Car</title>
      <div className="text-center">
        ...
        <p data-aos="fade-up" className="text-xl text-slate-800 font-serif mt-2 max-w-3xl mx-auto">
          Budget cars are a popular choice for individuals and families who are
          looking for affordable transportation options.
        </p>
      </div>
      ...
      <div className="grid gap-10 mt-16 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div data-aos="fade-right" className="bg-slate-400 rounded-lg flex flex-col items-center p-4">
          <Image src={alto} alt="Suzuki Alto" className="h-40 w-auto object-cover" />
          <div className="bg-white p-6 border border-gray-200 rounded-lg shadow-md mt-4 w-full">
            <h2 className="text-lg font-bold">SUZUKI Alto</h2>
            <div className="my-4">
            ...
            <div className="my-2">
              ...
              <p className="text-sm text-gray-500">Overtime: PKR 250/hr</p>
            </div>
            <div className="my-4 text-sm text-gray-500">
              <p>Refill fuel at the end of the day or pay PKR 32/KM</p>
              <p>Excluding fuel & overtime charges</p>
            </div>
            <div className="mt-4">
              <p className="text-red-500 line-through">4,200 PKR/day</p>
              <p className="text-xl font-bold text-green-500">3,800 PKR/day</p>
            </div>
        ...
        <div data-aos="fade-up" className="bg-slate-400 rounded-lg flex flex-col items-center p-4">
          <Image src={cultus} alt="Suzuki Cultus" className="h-40 w-auto object-cover" />
          <div className="bg-white p-6 border border-gray-200 rounded-lg shadow-md mt-4 w-full">
            <h2 className="text-lg font-bold">SUZUKI Cultus</h2>
            <div className="my-4">
              <p className="flex items-center">
                <span className="mr-2">🚗</span> 4 Seats
              </p>
            ...
            <div className="mt-4">
              <p className="text-red-500 line-through">4,800 PKR/day</p>
              <p className="text-xl font-bold text-green-500">4,200 PKR/day</p>
            </div>
            <div className="grid grid-cols-1 gap-4 mt-4 md:grid-cols-2">
              <button className="w-full px-4 py-2 text-white bg-purple-600 rounded hover:bg-purple-700">
                With Driver
        ...
        <div data-aos="fade-left" className="bg-slate-400 rounded-lg flex flex-col items-center p-4">
          <Image src={mira} alt="Daihatsu Mira" className="h-40 w-auto object-cover" />
          <div className="bg-white p-6 border border-gray-200 rounded-lg shadow-md mt-4 w-full">
            <h2 className="text-lg font-bold">Daihatsu Mira</h2>
            <div className="my-4">
              <p className="flex items-center">
                <span className="mr-2">🚗</span> 4 Seats
              </p>
            ...
            <div className="mt-4">
              <p className="text-red-500 line-through">5,000 PKR/day</p>
              <p className="text-xl font-bold text-green-500">4,500 PKR/day</p>
            </div>
            <div className="grid grid-cols-1 gap-4 mt-4 md:grid-cols-2">
              <button className="w-full px-4 py-2 text-white bg-purple-600 rounded hover:bg-purple-700">
                With Driver
      ...
      <div className="text-center mt-16">
        <h1 data-aos="fade-up" className="text-3xl text-slate-800 font-serif">
          Why Rent Budget Cars With QuickRent Car?
        </h1>
      ...
      <div className="flex justify-center items-center mt-8">
        <Link href="/">
          <h1 className="bg-slate-800 h-8 w-36 font-serif rounded-xl text-white flex justify-center items-center hover:bg-slate-900">
            Go To HomePage
          </h1>
        </Link>
      </div>
